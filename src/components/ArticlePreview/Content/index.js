...
const Content = (props) => (
  <Wrapper margin={props.margin}>
    <Link
      to={`/news/${props.article.slug}`} component={ArticleLink} InternalComponent={Title} value={props.article.title}
    />
    {props.description
      ? <Link to={`/news/${props.article.slug}`} component={ArticleLink} InternalComponent={Description} value={props.article.desc} />
      : null}
    <Meta>
