...
import { Banner, Content, Related } from './components'
...
const testProduct = Array(10).fill({ src: `https://picsum.photos/150`, title: 'Product' })
  ...
  return (
    <>
      ...
      <Content>
        ...
        <Related>
          <H3 style={{ marginBottom: '32px', textAlign: 'center' }}>See our products</H3>
